...
------------------------------------------------------------------------*/
 ...
 /*----------------------------------------------------------------------
    ...
    public static void AddStaff(Scanner input, PrintWriter output) {
                ...
                employee.add(new Staff(Emp_id,input.next(),input.next(), input.nextInt(), input.nextInt(), input.next(),input.next()));  
    ...
    public static void AddFaculty(Scanner input, PrintWriter output) {
                ...
                // Reading  Faculty Employee information
                int Emp_id= input.nextInt();
                employee.add(new Faculty(Emp_id,input.next(),input.next(), input.nextInt(), input.nextInt(), input.next(),input.next()));
                ...
                if (room_Index != -1) {
                    ...
                    if (event_Index != -1) {
                        ...
                        if (employee_Index != -1) {
                            ...
                            Booking.add(new Booking(book_No, room.get(room_Index), event.get(event_Index), employee.get(employee_Index)));
                            room.get(room_Index).setStatus("Reserved");
                            output.println("Booking with Number " + book_No + " is created and added to booking array list");
                            output.println();
